...
class HajeriHead1DashboardDashboard extends StatefulWidget {
  static const id = 'dashboard';
  final String orgId;
  // final String role;
  // final String dashboardView;
  const HajeriHead1DashboardDashboard({Key key, this.orgId}) : super(key: key);

  @override
  _DashboardState createState() => _DashboardState();
}

class _DashboardState extends State<HajeriHead1DashboardDashboard> {
  String dashboardView;
  // String dashboardView1;
...
//      print(data);
  ...
  void initState() {
    super.initState();
    orgId = widget.orgId;
    log("Org id in Head 1 DAshboard: " + orgId);
    // role = widget.role;
    isOrg = prefs.getBool('is_org');
    isSubOrg = prefs.getBool('is_sub_org');
    hajeriLevel = 'Hajeri-Head-1';
    // prefs.getString('hajeri_level');
    if (isSubOrg) {
