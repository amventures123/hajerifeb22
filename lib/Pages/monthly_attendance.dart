...
import 'package:hajeri/face_detection/Pages/scanner.dart';
import 'package:hajeri/pages/pie_chart.dart';
...
class _MonthlyAttendanceState extends State<MonthlyAttendance> {
  ...
  bool buttonVisibility1 = false, buttonVisibility2 = false;
  ...
  void initState() {
    ...
    _checkAttendanceReport();

    _getEmployeeList().then(
      (value) => returnSuccess().then(
        (value) => setState(
          () {
            isTypeSelected = true;
  ...
  Future _checkAttendanceReport() async {
    externalDir1 = await path.getExternalStorageDirectory();
    log("entered in report method");
    String url =
        '$kCheckAttendanceReport$orgId/All Employee/${_fromDate.toString().substring(0, 7)}';
    log("Url in check attendance" + url);
    ...
    Future.delayed(Duration(seconds: 3), () async {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          if (present == "Present") {
            setState(() {
              buttonVisibility1 = false;
              buttonVisibility2 = true;
            });
          } else if (present == "Not Present") {
            setState(() {
          ...
          log('$present');
          // fileName1 =
          //     'MonthlyAttendance_${_fromDate.toString().substring(0, 7)}.pdf';
        });
    ...
    //     log("report Data: " + reportData.toString());

    //     // log("${reportData[1]['message']}");
    //   }
        ...
        builder: (BuildContext context) {
          return SizedBox(
            ...
            child: AlertDialog(
              ...
              // content: Text(
              //     "${externalDir1.path.toString().substring(20, 59)}/$fileName1"),
              actions: [
                ElevatedButton(
                    onPressed: () async {
                      log("Opening : ${externalDir1.path}/$fileName1");
                      await OpenFile.open("${externalDir1.path}/$fileName1");
...
//      print(data);
  ...
  Future<String> returnSuccess() async {
    log("Entered: returnSuccess");
    return "success";
  }
...
//      print(data);
  ...
  //   log("Status: $_taskId");
  //   setState(() {
  //     _taskIdVal = _taskId.toString();

  //     log("Task Id is:$_taskIdVal");
  //   });
  // }
  ...
  Widget build(BuildContext context) {
    setState(() {
      fileName1 =
          'MonthlyAttendance_${_fromDate.toString().substring(0, 7)}.pdf';
      log("file name1 in build menthod:" + fileName1);
    });
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //             MaterialPageRoute(builder: (_) => MyDownloadingApp()));
        //       },
                        ...
                        child: DropdownButtonFormField(
                          ...
                          onChanged: (String newValue) async {
                            ...
                            if (!newValue.contains('-1')) {
                              ...
                              if (newValue == "All Employee") {
                                attendanceStatus = await returnSuccess();
                              } else {
            ...
            child: Container(
                ...
                child: Center(
                    child: Column(
                      ...
                      Text(
                        "Tap below button to download Monthly Attendance PDF.",
                                    ...
                                    Visibility(
                                      ...
                                      child: ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            // _createExcel();
                                            String url1 =
                                                "$kCreateAttendancePdf$orgId/All Employee/${_fromDate.toString().substring(0, 7)}";
                                            log("Generate pdf Report Url : " +
                                                url1);
                                            var response =
                                    ...
                                    Visibility(
                                      ...
                                      child: ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            String url =
                                                '$kDownloadMonthlyAttendancePdf$orgId/${_fromDate.toString().substring(0, 7)}/MonthlyAttendance_${_fromDate.toString().substring(0, 7)}.pdf';
                                            log("Download Url: " + url);
                                            final externalDir1 = await path
                                                .getExternalStorageDirectory();
                                            log("Download file Path: " +
                                                externalDir1.toString());
                                            ...
                                            final taskId =
                                              ...
                                              url: url,
                                              savedDir: externalDir1.path,
                                              showNotification: true,
                                              openFileFromNotification: true,
                                              // fileName: fileName1
                                            );
                                            log('Task ID:${taskId.asStream()}');
                                            ...
                                            // hajeri.in/apidev/attendance/{orgid}/2022/01/Attendance-Report-{orgid}-202201.pdf
                                          },
                                          child: Text("Download")),
                                    ),
                                  ]),
...
//       // debugger();
  ...
  //       ? (await path.getExternalStorageDirectory()).path + '/excel.xlsx'
