...
import 'package:hajeri/face_detection/main.dart' as faceApp;
...
class _LandingState extends State<Landing>
  ...
  void initState() {
    ...
    //     .addPersistentFrameCallback((_) => callFaceDetection);
    // Navigator.push(
    //     context, MaterialPageRoute(builder: (_) => faceApp.FaceApp()));
    isOrg = prefs.getBool('is_org');
    log("Entered inlanding");
    pageView = [
      Dashboard(
